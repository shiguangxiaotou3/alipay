...
use Shiguangxiaotou\Alipay\Schema\ServiceSchemaWriter;
use Shiguangxiaotou\Alipay\Schema\ServiceSchemaFactory;
use Shiguangxiaotou\Alipay\Schema\ServiceSchemaReader;
//读☺️xml文件 转成数组
try {
